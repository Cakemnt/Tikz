...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[x=1cm,y=1cm]
			...
			\draw[line width=0.3mm,yellow!60!black] (6,1.9) arc (90:190:1.8cm)--(6,0);
			\draw[line width=0.5mm,yellow!60!black] (6,1.9) arc (90:200:1.8cm);
			...
			\node[text=\fontsize{2pt}{0}\selectfont,color=white,rotate around={10:(3,2.72)}] at (3,2.72) {\tiny Đạp là sướng (DTS)};
		\end{tikzpicture}
	\end{center}
\end{document}